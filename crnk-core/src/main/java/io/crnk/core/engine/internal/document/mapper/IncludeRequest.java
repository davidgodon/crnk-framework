...
public class IncludeRequest {
	...
	public boolean isInclusionRequest(List<ResourceField> fieldPath,
	...
	public void removeDataFromIncluded() {
	...
	boolean isRelationIdSerialized(List<ResourceField> resourceFieldPath) {
	...
	Collection<Resource> filterProcessed(Collection<Resource> resourceList, ResourceField resourceField) {
		return populatedCache.filterProcessed(resourceList, resourceField);
	}

	void markForInclusion(Set<Resource> resources) {
		inclusions.addAll(util.toIds(resources));
	}


	public Resource merge(Object targetEntity) {
	...
	public void setupRelationId(Resource sourceResource, ResourceField relationshipField, Object targetEntityId) {
		// set the relation
	...
	public List<Resource> setupRelation(Resource sourceResource, ResourceField relationshipField,
			Object targetEntity) {
		// set the relation
		String relationshipName = relationshipField.getJsonName();
		Map<String, Relationship> relationships = sourceResource.getRelationships();
	...
	boolean containsResource(ResourceIdentifier id) {
		return resourceMap.containsKey(id);
	}

	Resource getResource(ResourceIdentifier id) {
		return Objects.requireNonNull(resourceMap.get(id));
	}

	Object getEntity(ResourceIdentifier id) {
