...
public class CollectionGetTest extends BaseControllerTest {
	...
	public void onGivenRequestResourceShouldLoadAutoIncludeFields() throws Exception {
		...
		Response response = responseGetResp.handle(jsonPath,
				new QueryParamsAdapter(resourceRegistry.getEntry(Task.class).getResourceInformation(), queryParams1,
						moduleRegistry), null, null);
	...
	public void onGivenRequestResourceShouldNotLoadAutoIncludeFields() throws Exception {
		...
		// WHEN
		Response response = responseGetResp.handle(jsonPath,
				new QueryParamsAdapter(resourceRegistry.getEntry(Task.class).getResourceInformation(), requestParams,
						moduleRegistry), null, null);
